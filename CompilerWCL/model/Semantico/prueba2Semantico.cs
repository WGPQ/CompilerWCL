...
{
    class prueba2Semantico
    {

        public prueba2Semantico()
        {
        ...
        public void generar_codigoCuadruplo()
        {
            ...
            for (int i = 0; i < this.listaReglasReconocidas.Count; i++)
            {
                ...
                switch (num_regla)
                {
                    ...
                    case 11: // L -> iN : <listavar> -> identificador <inicializa>
                        atrp.valor = listaReglasReconocidas[i].dato;
                        tipo_variable = buscarTipoTDS(atrp.valor.ToString());
                        if (tipo_variable  > 0)
                        {
                            atrp.no_terminal = listaReglasReconocidas[i].part_izquierda;
                            atrp.nombre = "Identificador";
